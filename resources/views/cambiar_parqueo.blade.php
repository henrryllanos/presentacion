...
@endforeach
    <form action="{{route('cambiar')}}" id="formulario" method="POST">
        @csrf
        <h3>Cambiar solicitud</h3>
        ...
        <div class="row">
            ...
            <div class="col btn" id="cancelar"><a href="{{route('reservas_respondidas')}}">Cancelar</a></div>
        </div>
    </form>
@endsection